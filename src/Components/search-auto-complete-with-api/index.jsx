...
export default function SearchAutoComplete() {
    ...
    const [fliterdUsers, setFilteredUsers] = useState([])
    ...
    return (
        <div className="search-autocomplete-conatiner">
            {
            ...
            {
                showDropdown && <Suggestions handleClick={handleClick} data={fliterdUsers}  />
            }
